...
<template>
  <div style="height: 100vh;overflow: hidden;background-color: aliceblue">
    <div style="width: 400px;margin: 100px auto;border: 1px solid #ddd;padding: 30px;border-radius: 10px;background-color: white">
      <el-form
          ref="ruleFormRef"
          :model="loginData"
          :rules="rules"
          ...
          status-icon
      >
        <div style="text-align: center;color: dodgerblue;font-size: 25px;font-weight: bold;margin-bottom: 25px">登  录</div>
